        ...
        <div class="relative flex justify-center md:gap-20">
            <div class="flex flex-col gap-6 max-w-[300px] md:max-w-[400px]">
                ...
                <p class="text-green-50 font-light">Sundarini Naturals, a farmers’ cooperative brand is working
                    ...
                    and happy through connecting themselves with the food conscious consumers all over the world.</p>
                <div class="flex gap-4 items-center">
                    ...
                    <a href="" class="hover:bg-green-700 p-3 rounded-full ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white font-bold" x="0px" y="0px"
                            viewBox="0,0,256,256">
            ...
            <div class="flex flex-col gap-6 max-w-[300px] md:max-w-[400px]">
                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li>
                        <img src="https://sundarbansjfmc.org/wp-content/uploads/2022/06/payments.png" alt=""
                            class="w-72 mt-4">
                    </li>
                </ul>
            </div>
