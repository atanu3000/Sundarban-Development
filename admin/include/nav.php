...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow align-items-center">
    ...
    <ul class="navbar-nav ms-auto my-auto">
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link btn btn-outline-danger border-danger mt-1" href="logout.php" onclick="return confirm('Are you sure to logout?')" role="button" style="height: 40px">
